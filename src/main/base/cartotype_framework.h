...
class CFramework: public MNavigatorObserver
    ...
    */
    ...
    void CompileStyleSheet(std::shared_ptr<CMapStyle>& aStyleSheet,double aScale);
    ...
    void ChangeStyleSheet(const CStyleSheetDataArray& aStyleSheetData,const CVariableDictionary* aStyleSheetVariables = nullptr);
